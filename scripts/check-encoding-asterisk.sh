...
active_files=(
  ...
  "asterisk_etc/magnus-conf.d/extensions_additional.conf"
  "asterisk_etc/magnus-conf.d/extensions_custom.conf"
  "asterisk_etc/magnus-conf.d/extensions-features.conf"
  "asterisk_etc/magnus-conf.d/routing.conf"
  "asterisk_etc/magnus-conf.d/tenants.conf"
  "asterisk_etc/features.conf"
  "asterisk_etc/magnus-conf.d/features_general_additional.conf"
  "asterisk_etc/magnus-conf.d/features_general_custom.conf"
  "asterisk_etc/magnus-conf.d/features_featuremap_additional.conf"
  "asterisk_etc/magnus-conf.d/features_featuremap_custom.conf"
  "asterisk_etc/magnus-conf.d/features_applicationmap_additional.conf"
  "asterisk_etc/magnus-conf.d/features_applicationmap_custom.conf"
